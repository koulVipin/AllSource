...
package com.vipin.webservices;

public class HelloWorldServiceLocator extends org.apache.axis.client.Service implements com.vipin.webservices.HelloWorldService {
    ...
    public com.vipin.webservices.HelloWorld getHelloWorld() throws javax.xml.rpc.ServiceException {
    ...
    public com.vipin.webservices.HelloWorld getHelloWorld(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.vipin.webservices.HelloWorldSoapBindingStub _stub = new com.vipin.webservices.HelloWorldSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.vipin.webservices.HelloWorld.class.isAssignableFrom(serviceEndpointInterface)) {
                com.vipin.webservices.HelloWorldSoapBindingStub _stub = new com.vipin.webservices.HelloWorldSoapBindingStub(new java.net.URL(HelloWorld_address), this);
                _stub.setPortName(getHelloWorldWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://webservices.vipin.com", "HelloWorldService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://webservices.vipin.com", "HelloWorld"));
        }
