...
<body>
	...
	<form action="/SpringMVCParamsProj/submitAdmissionForm.html" method="post">
		<table>
	...
	<table>
		...
		<tr><td><input type="submit" name="submitTheForm" value="Submit this form by clicking here" /></td></tr>
	</table>
