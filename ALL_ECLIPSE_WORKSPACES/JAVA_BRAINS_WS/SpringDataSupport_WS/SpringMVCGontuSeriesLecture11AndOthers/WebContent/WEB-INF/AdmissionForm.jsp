...
<body>
	...
	<form:errors path="studentDetailsKey.*"/>  <!-- How does this form know of "studentDetailsKey" ??? -->
	
	<form action="/SpringMVCGontuSeriesLecture11AndOthers/submitAdmissionForm.html" method="post">
		<table>
